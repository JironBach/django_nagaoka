...
# docer run
docker run -it -p 20080:80 -p 18000:8000 -p 23306:3306 -v /Users/js/.ssh:/root/.ssh -v /tmp:/tmp -v /Users/js/bin/python/test/nagaoka_proj:/root/nagaoka_proj --cap-add=NET_ADMIN junshimo2/nagaoka_django
